...
namespace QTFK.Services.CRUDRepositoryBuilders
{
    public static class MyTypeBuilder
    {
        ...
        //}
        public static Type CompileResultType(string typeSignature, string moduleName, Type parent = null, IDictionary<string, Type> properties = null)
        {
        ...
        private static TypeBuilder GetTypeBuilder(string typeSignature, string moduleName, Type parent = null)
        {
